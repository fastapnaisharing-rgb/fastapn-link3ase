...
const computeNextSyRunning = async () => {
  ...
  const TAB_CONFIG = {
    apcode: {
      ...
      combo: ['BU Code','Supplier Site','Tax-Type','Notice','Invoice No.','Digit'],
...
if (tab === 'apcode' || tab === 'iecode') {
        ...
        const rowStyle = { display:'grid', border:'0.5px solid #e8eaf0', borderRadius:'6px', overflow:'visible', marginBottom:'6px' };
